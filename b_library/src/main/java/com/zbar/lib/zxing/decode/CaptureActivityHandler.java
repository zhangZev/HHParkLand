...
package com.zbar.lib.zxing.decode;
...
import com.zbar.lib.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(CaptureActivity activity, Collection<BarcodeFormat> decodeFormats,
		...
		// 启动扫描线程
		this.decodeThread = new DecodeThread(activity, decodeFormats, baseHints, characterSet,
	...
	public void handleMessage(Message message) {
		if (message.what == R.id.restart_preview) {// 准备进行下一次扫描
			 ...
			 */
			ResolveInfo resolveInfo = this.activity.getPackageManager().resolveActivity(intent,
