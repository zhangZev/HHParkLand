 ...
 * which are used to configure the camera hardware. <br/>
 * 摄像头参数的设置类
 */
final class CameraConfigurationManager {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (afterSize != null
			...
			Log.w(TAG, "Camera said it supported preview size " + this.cameraResolution.x + 'x'
			        + this.cameraResolution.y + ", but after setting it, preview size is " + afterSize.width + 'x'
			        + afterSize.height);
