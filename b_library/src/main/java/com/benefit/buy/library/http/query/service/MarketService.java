 ...
 * the License.
 */
package com.benefit.buy.library.http.query.service;
...
public class MarketService {
    ...
    /**
     * Set the update check granularity level. Default is REVISION. <br>
     * Can be REVISION, MINOR, or MAJOR. <br>
     * App version format: MAJOR.MINOR.REVISION <br>
     * Example: <br>
     * Current app version: 3.1.2 <br>
     * Newest app version: 3.1.4 <br>
     * Update notice will show if level is REVISION, because the revision code is higher. <br>
    ...
    private String getQueryUrl() {
        ...
        String url = getHost() + "/api/market?app=" + appId + "&locale=" + locale + "&version=" + getVersion()
                + "&code=" + getVersionCode() + "&aq=" + Constants.VERSION;
        if (force) {
            url += "&force=true";
        }
        return url;
