 ...
 */
public class Common implements Comparator<File>, Runnable, OnClickListener, OnLongClickListener, OnItemClickListener,
                ...
                if (group >= 0) {
                    ...
                    if ((targetPacked != null) && (targetPacked.longValue() == packed)) {
                        if (child == -1) {
                            ...
                            ela.getChildView(group, child, child == (ela.getChildrenCount(group) - 1), convertView,
                                    elv);
                        }
    ...
    public static boolean shouldDelay(int groupPosition, int childPosition, View convertView, ViewGroup parent,
            String url) {
        ...
        if ((scrollState == null) || (scrollState == OnScrollListener.SCROLL_STATE_IDLE)
