...
import com.benefit.buy.library.utils.tools.ToolColor;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void setViewPager(ViewPager pagerview) {
        if (pager == pagerview) {
            return;
        }
        if (pager != null) {
            ...
            if (v instanceof TextView) {
                ...
                if (vImg instanceof ImageView) {
                    ...
                    if (VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB) {
                        if ((i == selectedPosition) || (i == (selectedPosition + 1)) || (i == (selectedPosition - 1))) {
                            //                    tab.setTextColor(selectedTabTextColor);
                            img.setAlpha(0f);
    ...
    public void setSelectedTextColor(int textColor) {
        selectedTabTextColor = textColor;
        updateTabStyles();
    }

    public void setSelectedTextColorResource(int resId) {
        selectedTabTextColor = getResources().getColor(resId);
        updateTabStyles();
    }
