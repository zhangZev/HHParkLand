...
package com.henghao.parkland.views.checkbox;
...
/**
 * Author : andy Date : 16/1/21 11:28 Email : andyxialm@gmail.com Github :
 * github.com/andyxialm Description : A custom CheckBox with animation for
 * Android
 */
...
public class SmoothCheckBox extends View implements Checkable {
	...
	private void init(AttributeSet attrs) {
		...
		int tickColor = ta.getColor(R.styleable.SmoothCheckBox_color_tick,
				COLOR_TICK);
		...
		mCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_color_checked,
				COLOR_CHECKED);
		mUnCheckedColor = ta.getColor(
				R.styleable.SmoothCheckBox_color_unchecked, COLOR_UNCHECKED);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		mStrokeWidth = (mStrokeWidth == 0 ? getMeasuredWidth() / 20
				: mStrokeWidth);
